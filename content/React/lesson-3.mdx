...
Next, we’ll move to **Lesson 4 — Hooks: Functions That Remember**, where we’ll see _why_ React moved away from classes, _how_ Hooks generalized the concept of component memory, and _what_ that changed about the way we reason about UI lifecycles.
